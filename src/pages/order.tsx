          ...
          <div className={styles.orderWrapper}>
            ...
            <div className={styles.infoWrapper}>
                        ...
                        <SwiperSlide key={index} style={{ width: 'fit-content' }}>
                          <div className={styles.itemWrapper}>
                            <div className={styles.imgWrapper}>
                              <Image
                                src={`${FILESERVER_URL}/upload/${item.product.image}`}
                                fill
              ...
              <div className={styles.deliveryWrapper}>
                <div className={styles.titleWrapper}>Способ получения</div>
              ...
              <div className={styles.contactsWrapper}>
                <div className={styles.titleWrapper}>Получатель</div>
              ...
              <div className={styles.paymentWrapper}>
                <div className={styles.titleWrapper}>Оплата</div>
              ...
              <div className={styles.resultWrapper}>
                ...
                <div className={styles.infoWrapper}>
                  Окончательная стоимость заказа будет
                  <br />
            ...
            <div className={styles.priceSectionWrapper}>
              ...
              <LinkButton
                element="button"
                disabled={
                  name.length >= 1 && lastName.length >= 1 && phone.length >= 1 ? false : true
                }
                onClick={checkout}
              >
                Оформить заказ

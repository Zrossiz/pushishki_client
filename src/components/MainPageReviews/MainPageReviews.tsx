                 ...
                 >
                    <SwiperSlide>
                        <div className={styles.descWrapper}>
                            <span>
                                Отличное место для покупки электромобиля для ребёнка. 
                                Очень большой выбор машинок и мотоциклов в магазине. 
                                Знающий человек на телефоне, внимательные продавцы, своевременная доставка.
                            </span>
                        </div>

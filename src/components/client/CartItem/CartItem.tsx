          ...
          <div className={styles.colorWrapper}>
            ...
            {product.color.startsWith('http') ? (
              <span className={styles.color}>
                <Image src={product.color} alt={product.color} fill />
              </span>
            ) : (
      ...
      <div className={styles.priceCounterWrapper}>
        ...
        <div className={styles.counterWrapper}>
          <div
            ...
            onClick={() => removeFromCart(product.product.id, product.color)}
          >
            -
          </div>
          <div className={styles.counter}>{product.count}</div>
          <div className={styles.plus} onClick={() => addToCart(product.product.id, product.color)}>
            +
          </div>
        </div>
      </div>
        ...
        {hover && (
          ...
          >
            ...
            <div
              ...
              onClick={() => removeFromCart(product.product.id, product.color, true)}
            >
